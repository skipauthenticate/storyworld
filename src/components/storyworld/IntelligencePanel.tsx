    ...
    <div className="flex flex-col items-center text-center py-3 px-3 space-y-3">
      {phase === "idle" && !hasEnrichment && (
        <div className="flex flex-col items-center gap-2 py-2">
          ...
          <span className="text-[11px] text-muted-foreground">Enrichment not enabled</span>
          <span className="text-[9px] text-muted-foreground/60">Re-import with "Enrich" toggle on</span>
        </div>
      )}
